/* ============================================================
   LP_CONFIG — マレーシア 合同セミナー 2026年6月4日 (日本語版)
   Path: 2026/malaysia/seminar/cross-cultural/config_ja.js
    Updated: 2026-05-09 v9 FITOKIO共催対応
   ============================================================ */
window.LP_CONFIG = {

  meta: {
    lang: 'ja',
    title: '無料合同セミナー：マレーシア人材マネジメント×健康経営の実践知 2026年6月4日 | WS PARTNERS',
    description: 'マレーシアの日系企業にお勤めの経営層・管理職層の日本人向け無料合同セミナー。2026年6月4日（木）JACTIM会場にてリアル開催。WS PARTNERS × FITOKIO共催。',
  ...
  hero: {
    ...
    img_sub1: 'images/photo_trainer_konishi.jpg',
    img_sub2: '',
    ...
    date_label: '【日時】',
    date: '<strong>2026年6月4日（木）　15:00〜17:00</strong><br><span style="font-size:0.82em;font-weight:400">（マレーシア時間）</span>',
    deadline_label: '【参加費】',
...
<p>ぜひこの機会にご参加ください。</p>`,
  ...
  program: {
    ...
    details: [
      ...
      { label: '時間',     value: '15:00〜17:00（マレーシア時間）' },
...
※第二部終了後、軽食を交えた懇親会を開催する可能性がございます。`
      }
    ]
  },
  ...
  instructor: {
    ...
    items: [
      ...
      {
        img: 'images/photo_trainer_konishi.jpg',
        name: '小西 慧　Kei Konishi',
        role: 'FITOKIO 営業マネージャー・セミナー講師',
        profile: 'フィットネストレーナーとして栄養指導や姿勢改善を専門とし、日本国内での指導経験を積んだ後、マレーシアへ渡航。マレーシア国立のIMU大学院にて公衆衛生（Public Health）を専攻し、現地の健康課題を学術的・実践的両面から追究。現在はFITOKIOにて営業マネージャーを務めながら、法人向け健康経営セミナーの講師としても活躍。日本企業が直面するマレーシア人スタッフの健康管理課題に対し、現場目線の実践的なアドバイスを提供している。'
      }
    ]
  },
...
<span style="display:flex;flex-direction:column;gap:10px;margin-top:4px">
  ...
  apply: {
    ...
    mailto_subject: 'お申し込み - 【『無料合同セミナー：マレーシア人材マネジメント×健康経営の実践知』セミナー （マレーシア）(2026.6)】',
