...
window.LP_CONFIG = {
  ...
  hero: {
    ...
    img_sub1: '',
    img_sub2: '',
    subtitle: '無料セミナー：マレーシア人メンバーの自律に向けたマネジメントのコツ',
  ...
  consult: {
    ...
    title: 'マレーシア人部下が変わる！マネジメント３つの秘訣',
    body: `<p style="font-size:1.05rem;line-height:1.8">あなたのマレーシア人部下のパフォーマンスに、100%満足していますか。<br>マレーシア人部下の指導に、悩みや課題はありませんか。</p>
