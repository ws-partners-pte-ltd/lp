...
window.LP_CONFIG = {
  ...
  hero: {
    ...
    cta_text: '無料で申し込む',
    target_label: '【対象】',
    target: 'マレーシアの日系企業にお勤めの経営層および管理職層の日本人の方<br><span style="font-size:0.88em">＊新任駐在員の方にもおすすめです！</span>',
    badge_en: '現地・オンライン',
    badge_ja: '日本語で実施！'
  },
...
<span style="display:flex;flex-direction:column;gap:10px;margin-top:4px">
  ...
  forms: {
    ...
    hubspot_region:    'na1',
    thank_you_url:     '/_template/_thank-you.html?lang=ja'
  }
