/* ============================================================
   LP_CONFIG — インドネシア 単発セミナー 2026年5月13日 (日本語版)
   Path: 2026/indonesia/seminar/config_ja.js
   ============================================================ */
window.LP_CONFIG = {
...
<p style="margin-top:12px;font-weight:700;color:var(--primary)">具体的な事例をもとにご体験いただけます。</p>
  ...
  program: {
    ...
    schedule: [
      ...
      {
        part: '15:05〜',
        title: 'なぜ、言われた通りにやったのに怒られるのか？ ─ 基準理解と実践',
        body: `・なぜ「言われた通りにやったのに怒られる」が起きるのか ─ 基準の構造を分解する<br>
・日本人上司が無意識に重視している"信頼の判断基準"とは何か<br>
...
・日本人とインドネシア人のあいだに「共通言語」をつくるための実践フレーム`
  ...
  cancel: {
    en: '',
    title: '理解が変われば、組織も変わる',
    body: `<p>ここまでお読みいただき、おそらくお気づきのはずです。</p>
<p>問題は、日本人上司の性格でも、インドネシア人マネジャーの姿勢でもありません。<br>
そのあいだにある、言語化されていない「基準」の違いです。</p>
...
<p><strong>理解が変われば、組織も変わる。</strong><br>
