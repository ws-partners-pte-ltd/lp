/* ============================================================
   LP_CONFIG — インドネシア 単発セミナー 2026年5月5日 (日本語版)
...
<span style="display:flex;flex-direction:column;gap:10px;margin-top:4px">
  ...
  apply: {
    en: 'APPLY',
    title: 'セミナーへのお申し込み',
    body: `下記フォームよりお申し込みください。<strong>参加費は無料</strong>です。<br>お申し込み後、Zoom接続情報をEメールにてご連絡いたします。`
  },
  ...
  forms: {
    google_url:        'https://docs.google.com/forms/d/e/1FAIpQLSfHQcnvP0v5kHEboKMpAQaZbZXOytSzNEMqc5YWYzk5Tk0JqQ/viewform?embedded=true&entry.2075185131=ja',
