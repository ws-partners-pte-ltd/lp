...
<span style="display:flex;flex-direction:column;gap:10px;margin-top:4px">
  ...
  apply: {
    en: 'APPLY',
    title: 'セミナーへのお申し込み',
    body: `下記フォームよりお申し込みください。<strong>参加費は無料</strong>です。<br>お申し込み後、Zoom接続情報をEメールにてご連絡いたします。<br><br><span style="color:#c0392b;font-weight:700;">※重要：メールアドレスに誤りがあると、当日のご案内メールが届きません。ご入力内容を必ずご確認ください。</span>`
  },
