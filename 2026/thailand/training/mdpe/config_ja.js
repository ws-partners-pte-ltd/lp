...
費用： 無料`,
  ...
  program: {
    ...
    schedule: [
      { part: '第１回', title: 'マネジャーの役割と、マネジメントスタイルの違い',           date: '7月3日（金） | 10:00 - 12:00（バンコク時間）' },
      { part: '第２回', title: '業務のマネジメントと、報告・連絡・相談（前編）',           date: '7月10日（金） | 10:00 - 12:00（バンコク時間）' },
      { part: '第３回', title: '業務のマネジメントと、報告・連絡・相談（後編）',           date: '7月17日（金） | 10:00 - 12:00（バンコク時間）' },
      { part: '第４回', title: '人材の保全：部下との信頼関係を築く',                     date: '7月24日（金） | 10:00 - 12:00（バンコク時間）' },
      { part: '第５回', title: '人材の育成：仕事を任せて人を育てる（前編）',               date: '7月31日（金） | 10:00 - 12:00（バンコク時間）' },
      { part: '第６回', title: '人材の育成：仕事を任せて人を育てる（中編）',               date: '8月7日（金） | 10:00 - 12:00（バンコク時間）' },
      { part: '第７回', title: '人材の育成：仕事を任せて人を育てる（後編）',               date: '8月14日（金） | 10:00 - 12:00（バンコク時間）' },
      { part: '第８回', title: '学んだことのレビューと、追加ケーススタディ',               date: '8月21日（金） | 10:00 - 12:00（バンコク時間）' }
    ]
  },
